...
Generated new keypair and alias for address with scheme "ed25519" [pensive-diamond: 0x7a6a3e2e34d414a480ae1483d9d0a0020bd53fddbc3ea63658724b4acd330ba4]
  secret recovery phrase : [embark twenty inmate token extend wise soap hat inch remove when box]
